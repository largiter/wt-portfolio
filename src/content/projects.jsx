const imagesRoot = '/assets/images/projects-main/earthly/';
...
export const projects = {
  ...
  content: [
          ...
          list: {
            ...
            listItems: [
              <>
                ...
                more about our planet’s current situation regarding climate and
                environmental changes
              </>,
              <>
                <strong>Educational:</strong> in addition, the app will provide
                tips and solutions on everyday habits and actions the user can
                undertake to make the situation better
              </>,
              <>
    ...
    },
    {
      ...
      contentBody: [{ img: `${imagesRoot}architecture.jpg` }],
    },
    {
      id: 5,
      type: 1,
